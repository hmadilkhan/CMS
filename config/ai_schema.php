    ...
    'tables' => [
        'projects' => [
            ...
            'allowed_columns' => [
                ...
                'mpu_required',
                'meter_spot_request_date',
                'meter_spot_request_number',
                'meter_spot_result',
        ...
        'project_document_follow_ups' => [
            'model' => \App\Models\ProjectDocumentFollowUp::class,
            'table' => 'project_document_follow_ups',
            'allowed_columns' => [
                'id',
                'project_id',
                'employee_id',
            ...
            'relationships' => [
                ...
                'resolvedBy' => [
                    'table' => 'users',
                    'local_key' => 'resolved_by',
                    'foreign_key' => 'id',
                ],
            ],
            'sensitive_columns' => [],
            'default_sort_column' => 'opened_at',
            'access_rule' => 'project_access',
        ],
