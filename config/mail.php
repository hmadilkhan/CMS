    ...
    */
    ...
    'mailers' => [
        ...
        'smtp' => [
            ...
            'host' => env('MAIL_HOST', 'smtp.mailgun.org'),
            'port' => env('MAIL_PORT', 587),
            'encryption' => (int) env('MAIL_PORT', 587) === 465 && env('MAIL_ENCRYPTION', 'tls') === 'tls' ? 'ssl' : env('MAIL_ENCRYPTION', 'tls'),
        ...
        'info' => [
            ...
            'encryption' => (int) env('INFO_MAIL_PORT', 587) === 465 && env('INFO_MAIL_ENCRYPTION', 'tls') === 'tls' ? 'ssl' : env('INFO_MAIL_ENCRYPTION', 'tls'),
        ...
        'dealreview' => [
            ...
            'encryption' => (int) env('DEALREVIEW_MAIL_PORT', 587) === 465 && env('DEALREVIEW_MAIL_ENCRYPTION', 'tls') === 'tls' ? 'ssl' : env('DEALREVIEW_MAIL_ENCRYPTION', 'tls'),
        ...
        'sitesurvey' => [
            ...
            'encryption' => (int) env('SITESURVEY_MAIL_PORT', 587) === 465 && env('SITESURVEY_MAIL_ENCRYPTION', 'tls') === 'tls' ? 'ssl' : env('SITESURVEY_MAIL_ENCRYPTION', 'tls'),
        ...
        'engineering' => [
            ...
            'encryption' => (int) env('ENGINEERING_MAIL_PORT', 587) === 465 && env('ENGINEERING_MAIL_ENCRYPTION', 'tls') === 'tls' ? 'ssl' : env('ENGINEERING_MAIL_ENCRYPTION', 'tls'),
        ...
        'permitting' => [
            ...
            'encryption' => (int) env('PERMITTING_MAIL_PORT', 587) === 465 && env('PERMITTING_MAIL_ENCRYPTION', 'tls') === 'tls' ? 'ssl' : env('PERMITTING_MAIL_ENCRYPTION', 'tls'),
        ...
        'installation' => [
            ...
            'encryption' => (int) env('INSTALLATION_MAIL_PORT', 587) === 465 && env('INSTALLATION_MAIL_ENCRYPTION', 'tls') === 'tls' ? 'ssl' : env('INSTALLATION_MAIL_ENCRYPTION', 'tls'),
        ...
        'inspection' => [
            ...
            'encryption' => (int) env('INSPECTION_MAIL_PORT', 587) === 465 && env('INSPECTION_MAIL_ENCRYPTION', 'tls') === 'tls' ? 'ssl' : env('INSPECTION_MAIL_ENCRYPTION', 'tls'),
        ...
        'pto' => [
            ...
            'encryption' => (int) env('PTO_MAIL_PORT', 587) === 465 && env('PTO_MAIL_ENCRYPTION', 'tls') === 'tls' ? 'ssl' : env('PTO_MAIL_ENCRYPTION', 'tls'),
        ...
        'coc' => [
            ...
            'encryption' => (int) env('COC_MAIL_PORT', 587) === 465 && env('COC_MAIL_ENCRYPTION', 'tls') === 'tls' ? 'ssl' : env('COC_MAIL_ENCRYPTION', 'tls'),
