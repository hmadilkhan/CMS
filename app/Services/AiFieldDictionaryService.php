...
class AiFieldDictionaryService
{
    ...
    private const SYNONYMS = [
        ...
        'invoice' => ['project_invoice_details.invoice_type', 'project_invoice_details.invoice_date', 'project_invoice_details.amount'],
        'invoice details' => ['project_invoice_details.invoice_type', 'project_invoice_details.invoice_date', 'project_invoice_details.amount'],
        'invoice amount' => ['project_invoice_details.amount'],
        'labor invoice' => ['project_invoice_details.invoice_type'],
        'material invoice' => ['project_invoice_details.invoice_type'],
