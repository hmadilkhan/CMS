...
<div class="card card-info">
    <div class="card-header">
        <h4 class="card-title">Add Utility Company</h4>
    </div>
    <div class="card-body">
        <!-- ADD NEW PRODUCT PART START -->
        <form method="POST" action="{{ !empty($utility) ? route('utility.type.update',$utility->id) :  route('utility.type.store') }}">
            @csrf
            ...
            <div class="row g-3  mb-3 align-items-center">
                ...
                <div class="col-sm-4 ">
                    ...
                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="Enter Name" value="{{ !empty($utility) ? $utility->name : old('name') }}">
                    @error('name')
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a style="cursor: pointer;" data-toggle="tooltip" title="Edit" href="{{ route('view.utility.types',$utilityList->id)}}">
                            <i class="icofont-pencil text-warning"></i></a>
                        <a style="cursor: pointer;" data-toggle="tooltip" title="Delete" class="ml-2" onclick="deleteDealerModal('{{ $utilityList->id }}')">
