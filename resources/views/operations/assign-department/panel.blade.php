{{--
    The Assign Department screen's body - see operations/departments/panel.blade.php
    for what `$console` means here.
--}}
@php
    $console = $console ?? false;
    $screenUrl = fn ($id = null) => $console
        ? route('operations.console', array_filter(['section' => 'assign-department', 'id' => $id]))
        : route('assign-department.index', array_filter(['id' => $id]));
@endphp
@if(session('success'))
...
<div class="card operation-card">
    ...
    <div class="card-body">
        <form class="operation-form" method="POST" action="{{ !empty($assignDepartment) ? route('assign-department.update', $assignDepartment->id) : route('assign-department.store') }}">
            ...
            @if ($console)
            <input type="hidden" name="ops_section" value="assign-department" />
            @endif
            <div class="row g-3 align-items-start">
                ...
                <div class="col-12">
                    <div class="operation-actions">
                        ...
                        <a href="{{ $screenUrl() }}" class="btn btn-outline-secondary">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a class="action-link" data-toggle="tooltip" title="Edit" href="{{ $screenUrl($assign->id) }}">
