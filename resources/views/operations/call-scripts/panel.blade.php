{{--
    The Call Scripts screen's body - see operations/departments/panel.blade.php
    for what `$console` means here.
--}}
@php
    $console = $console ?? false;
    $screenUrl = fn ($id = null) => $console
        ? route('operations.console', array_filter(['section' => 'call-scripts', 'id' => $id]))
        : route('call.scripts.list', array_filter(['id' => $id]));
@endphp
    ...
    <div class="card operation-card">
        ...
        <div class="card-body">
            <form class="operation-form" method="POST"
                ...
                @if ($console)
                <input type="hidden" name="ops_section" value="call-scripts" />
                @endif
                <div class="row g-3">
