<div class="sidebar px-4 py-4 py-md-5 me-0">
    <div class="d-flex flex-column h-100">
        ...
        <ul class="menu-list flex-grow-1 mt-3">
            ...
            @can('User Management')
            <li class="collapsed">
                <a class="m-link {{ (Route::currentRouteName() == 'module-types.index' or Route::currentRouteName() == 'view-redline-cost' or Route::currentRouteName() == 'view-dealer-fee' or Route::currentRouteName() == 'tools.index' or Route::currentRouteName() == 'office-costs.index' or Route::currentRouteName() == 'view-adders' or Route::currentRouteName() == 'view.adder.types' or Route::currentRouteName() == 'view-inverter-type' ) ? 'show' : '' }}" data-bs-toggle="collapse" data-bs-target="#module-types" href="#">
                    <i class="icofont-briefcase"></i><span>Operations</span> <span class="arrow icofont-dotted-down ms-auto text-end fs-5"></span></a>
                <!-- Menu: Sub menu ul -->
                <ul class="sub-menu collapse {{ (Route::currentRouteName() == 'module-types.index' or Route::currentRouteName() == 'view-redline-cost' or Route::currentRouteName() == 'view-dealer-fee' or Route::currentRouteName() == 'tools.index' or Route::currentRouteName() == 'office-costs.index' or Route::currentRouteName() == 'view-adders' or Route::currentRouteName() == 'view.adder.types' or Route::currentRouteName() == 'view-inverter-type' ) ? 'show' : '' }}" id="module-types">
