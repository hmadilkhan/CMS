<div class="sidebar px-4 py-4 py-md-5 me-0">
    <div class="d-flex flex-column h-100">
        ...
        <ul class="menu-list flex-grow-1 mt-3">
            ...
            @can('User Management')
            <li class="collapsed">
                <a class="m-link {{ (Route::currentRouteName() == 'module-types.index' or Route::currentRouteName() == 'view-redline-cost' or Route::currentRouteName() == 'view-dealer-fee' or Route::currentRouteName() == 'tools.index' or Route::currentRouteName() == 'tools.manage' or Route::currentRouteName() == 'office-costs.index' or Route::currentRouteName() == 'labor-costs.index' or Route::currentRouteName() == 'departments.list' or Route::currentRouteName() == 'sub.departments.list' or Route::currentRouteName() == 'view-adders' or Route::currentRouteName() == 'view.adder.types' or Route::currentRouteName() == 'view-inverter-type' or Route::currentRouteName() == 'sales.partner.types' or Route::currentRouteName() == 'finance.option.types' or Route::currentRouteName() == 'email.types.list' or Route::currentRouteName() == 'email.scripts.list' or Route::currentRouteName() == 'loan.term' or Route::currentRouteName() == 'view.utility.types' or Route::currentRouteName() == 'sub.contractor' or Route::currentRouteName() == 'assign-department.index' ) ? 'show' : '' }}" data-bs-toggle="collapse" data-bs-target="#module-types" href="#">
                    <i class="icofont-briefcase"></i><span>Operations</span> <span class="arrow icofont-dotted-down ms-auto text-end fs-5"></span></a>
                <!-- Menu: Sub menu ul -->
                <ul class="sub-menu collapse {{ (Route::currentRouteName() == 'module-types.index' or Route::currentRouteName() == 'view-redline-cost' or Route::currentRouteName() == 'view-dealer-fee' or Route::currentRouteName() == 'tools.index' or Route::currentRouteName() == 'tools.manage' or Route::currentRouteName() == 'office-costs.index' or Route::currentRouteName() == 'labor-costs.index' or Route::currentRouteName() == 'departments.list' or Route::currentRouteName() == 'sub.departments.list' or Route::currentRouteName() == 'view-adders' or Route::currentRouteName() == 'view.adder.types' or Route::currentRouteName() == 'view-inverter-type' or Route::currentRouteName() == 'sales.partner.types' or Route::currentRouteName() == 'finance.option.types' or Route::currentRouteName() == 'email.types.list' or Route::currentRouteName() == 'email.scripts.list' or Route::currentRouteName() == 'loan.term' or Route::currentRouteName() == 'view.utility.types' or Route::currentRouteName() == 'sub.contractor' or Route::currentRouteName() == 'assign-department.index' ) ? 'show' : '' }}" id="module-types">
                    {{-- One window for everything below it; the individual screens
                         keep their own links and their own URLs. --}}
                    <li><a class="ms-link {{ Route::currentRouteName() == 'operations.console' ? 'active' : '' }}" href="{{route('operations.console')}}"><span>Operations Console</span></a></li>
                    ...
                    <li><a class="ms-link {{ (Route::currentRouteName() == 'tools.index' or Route::currentRouteName() == 'tools.manage') ? 'active' : '' }}" href="{{route('tools.manage')}}"><span>Tools</span></a></li>
                    ...
                    <li><a class="ms-link {{ Route::currentRouteName() == 'departments.list' ? 'active' : '' }}" href="{{route('departments.list')}}"><span>Departments</span></a></li>
                    <li><a class="ms-link {{ Route::currentRouteName() == 'sub.departments.list' ? 'active' : '' }}" href="{{route('sub.departments.list')}}"><span>Sub Departments</span></a></li>
                    ...
                    {{-- <li><a class="ms-link {{ Route::currentRouteName() == 'call.types.list' ? 'active' : '' }}" href="{{route('call.types.list')}}"><span>Call Types</span></a></li> --}}
                    ...
                    <li><a class="ms-link {{ Route::currentRouteName() == 'email.types.list' ? 'active' : '' }}" href="{{route('email.types.list')}}"><span>Email Types</span></a></li>
