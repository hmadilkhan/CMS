...
<div class="body d-flex py-lg-3 py-md-2">
    <div class="container-xxl">
        <div class="operation-page-header">
            <div>
                <h1 class="operation-page-title"><i class="icofont-chart-flow me-2"></i>Forecast Report</h1>
                <p class="operation-page-subtitle">Review forecast values across a selected sold date range.</p>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="operation-form row g-3 align-items-end mb-3">
                    ...
                    <div class="col-sm-4">
                        ...
                        <button class="btn btn-primary" type="button" onclick="generateReport()"><i class="icofont-save"></i> Submit</button>
                        <button class="btn btn-success text-white" type="button" onclick="excelExport()"><i class="icofont-file-excel"></i> Excel Export</button>
                        <button class="btn btn-danger text-white" type="button" onclick="pdfExport()"><i class="icofont-file-pdf"></i> PDF Export</button>
                        </div>
                    </div>
                </div>
            </div>
