    ...
    <div class="body d-flex py-lg-3 py-md-2">
        <div class="container-xxl">
            <div class="operation-page-header">
                <div>
                    <h1 class="operation-page-title"><i class="icofont-chart-bar-graph me-2"></i>Profitability Report</h1>
                    <p class="operation-page-subtitle">Review profitability by sales partner and date range.</p>
                </div>
            </div>
