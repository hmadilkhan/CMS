    ...
    <div class="w-100">
        <div class="operation-page-header">
            <div>
                ...
                <p class="operation-page-subtitle">Update customer details, system configuration, adders, and financing in
                    one form.</p>
            </div>
                            ...
                            <div class="col-sm-4">
                                ...
                                <select class="form-select select2" aria-label="Default select Sales Partner"
                                    ...
                                    @foreach ($partners as $partner)
                                        <option
                                            {{ old('sales_partner_id', $customer->sales_partner_id) == $partner->id ? 'selected' : '' }}
                                            value="{{ $partner->id }}">
                                            {{ $partner->name }}
                                        </option>
                                    @endforeach
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-sm-4">
                                ...
                                <select class="form-select select2" aria-label="Default select Module Type"
                                    ...
                                    @foreach ($modules as $module)
                                        <option
                                            {{ old('module_type_id', $customer->module_type_id) == $module->id ? 'selected' : '' }}
                                            value="{{ $module->id }}">
                                            {{ $module->name }}
                                        </option>
                                    @endforeach
                            ...
                            <div class="col-sm-4">
                                ...
                                <select class="form-select select2" aria-label="Default select Inverter Type"
                                    ...
                                    @foreach ($inverter_types as $inverter)
                                        <option
                                            {{ old('inverter_type_id', $customer->inverter_type_id) == $inverter->id ? 'selected' : '' }}
                                            value="{{ $inverter->id }}">
                                            {{ $inverter->name }}
                                        </option>
                                    @endforeach
                            ...
                            <div class="col-sm-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="inverter_qty" name="inverter_qty"
                                    ...
                                    value="{{ old('inverter_qty', $customer->inverter_qty) }}">
                                @error('inverter_qty')
                                    <div class="text-danger message mt-2">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div id="loadIdDiv" class="col-sm-4 ">
                                ...
                                <input type="text" class="form-control" id="loanId" name="loanId"
                                    placeholder="loan Id" value="{{ old('loanId', $customer->loan_id) }}">
                                @error('loanId')
                                    <div class="text-danger message mt-2">{{ $message }}</div>
                                @enderror
                            </div>
