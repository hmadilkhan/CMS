        ...
        <form id="form" method="post" action="{{route('customers.update',$customer->id)}}" enctype="multipart/form-data">
            ...
            <div class="row g-3 mb-3">
                ...
                <div class="col-sm-4">
                    ...
                    <select class="form-select select2" aria-label="Default select Inverter Type" id="inverter_type_id" name="inverter_type_id" onchange="getRedlineCost()">
                        ...
                        <option {{$customer->inverter_type_id == $inverter->id ? 'selected' : ''}} value="{{ $inverter->id }}">
                            {{ $inverter->name }}
                        </option>
                        @endforeach
                    </select>
                ...
                <div class="col-sm-4 mb-3">
                    ...
                    <input type="text" class="form-control" id="inverter_qty" name="inverter_qty" placeholder="Inverter Qty" value="{{$customer->inverter_qty}}">
                    @error("inverter_qty")
                    <div class="text-danger message mt-2">{{$message}}</div>
                    @enderror
                </div>
            ...
            <div class="row g-3 mb-3">
                ...
                <div class="col-sm-3 mb-3">
                    ...
                    <input type="text" class="form-control" id="amount" name="amount" placeholder="Adders Amount" value="{{$customer->amount}}">
                    @error("amount")
                    <div class="text-danger message mt-2">{{$message}}</div>
                    @enderror
                </div>
            ...
            <div class="row g-3 mb-3">
                <div class="col-sm-3 mb-3">
                    ...
                    <select class="form-select select2" aria-label="Default select Finance Option" id="finance_option_id" name="finance_option_id">
                        ...
                        <option {{$customer->finances->finance_option_id == $financeOption->id ? 'selected' : ''}} value="{{ $financeOption->id }}">
                            {{ $financeOption->name }}
                        </option>
                        @endforeach
                    </select>
                ...
                <div class="col-sm-3 mb-3">
                    ...
                    <input type="text" class="form-control" id="contract_amount" name="contract_amount" placeholder="Contract Amount" onblur="dealerFee()" value="{{$customer->finances->contract_amount}}">
                ...
                <div class="col-sm-3 mb-3">
                    <label for="adders" class="form-label">Adders</label>
                    <input type="text" class="form-control" id="adders_amount" name="adders_amount" placeholder="Adders" value="{{$customer->finances->adders}}">
                    @error("adders")
                    <div class="text-danger message mt-2">{{$message}}</div>
                    @enderror
                </div>
                ...
                <div class="col-sm-3 mb-3">
                    ...
                    <input readonly type="text" class="form-control" id="dealer_fee" name="dealer_fee" placeholder="Dealer Fee" value="{{$customer->finances->dealer_fee}}">
                    @error("dealer_fee")
                    <div class="text-danger message mt-2">{{$message}}</div>
                    @enderror
                </div>
                <div class="col-sm-3 mb-3">
                    ...
                    <input type="text" class="form-control" id="dealer_fee_amount" name="dealer_fee_amount" placeholder="Dealer Fee Amount" value="{{$customer->finances->dealer_fee_amount}}">
