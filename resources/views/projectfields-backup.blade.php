{{--@if($project->department->id == 1)--}}
                    <div class="col-sm-3 mb-3 additionalFields fields_2">
                    ...
                    <div class="col-sm-3 mb-3 additionalFields fields_3" >
                    ...
                    <div class="col-sm-3 additionalFields fields_3" >
                    ...
                    <div class="col-sm-3 additionalFields fields_4">
                    ...
                    <div class="col-sm-3 mb-3 additionalFields fields_5"  >
                    ...
                    <div class="col-sm-3 mb-3 additionalFields fields_6" >
                    ...
                    <div class="col-sm-3 mb-3 additionalFields fields_7">
                    ...
                    <div class="col-sm-3 mb-3 additionalFields fields_8" >
                    ...
                    <div class="col-sm-3 mb-3 additionalFields fields_9">
