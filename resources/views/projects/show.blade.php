        ...
        <div class="card">
            <div class="card-body">
                <ul class="nav nav-tabs px-3 border-bottom-0" role="tablist">
                    ...
                    @endcan
                    <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#communication" role="tab">Communication</a></li>
                    {{-- @endif --}}
                </ul>
            </div>
        </div>
...
<div class="card card-info mt-2">
    <div class="card-body">
        <div class="row clearfix">
            <div class="col-md-12">
                <div class="card border-0 mb-4 no-bg">
                    <div class="card-header py-3 px-0 d-sm-flex align-items-center text-center  justify-content-between border-bottom">
    ...
    <div class="card mt-1">
        <div class="card-body">
            <div class="card-header py-3 px-0 d-sm-flex align-items-center  border-bottom">
                <h3 class=" fw-bold flex-fill mb-0 mt-sm-0" data-bs-toggle="collapse" data-bs-target="#adderTable" aria-expanded="false" aria-controls="adderTable">Adders Details
                </h3>
            </div>
                ...
                <table id="adderTable" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr id="row{{ $key }}">
                            ...
                            <td>{{ $adder->amount }}</td>
                            <td>
                                <i style='cursor: pointer;' class='icofont-trash text-danger' onClick="deleteItem('{{ $index }}','{{ $adder->id }}')">
                                    Delete</i>
                            </td>
                        </tr>
                        @endforeach
...
<div class="tab-pane fade" id="communication" role="tabpanel">
    <div class="card mt-1">
        <div class="card-body">
            <ul class="nav nav-tabs px-3 border-bottom-0" role="tablist">
                <li class="nav-item"><a class="nav-link active" data-bs-toggle="tab" href="#calls" role="tab">Calls</a></li>
                                ...
                                <div class="card-body">
                                    <div class="row clearfix">
                                        <div class="col-md-12">
                                            <div class="card border-0 mb-4 no-bg">
                                                <div class="card-header py-3 px-0 d-sm-flex align-items-center  justify-content-between border-bottom">
                                                    <h3 class=" fw-bold flex-fill mb-0 mt-sm-0 m-4">Call Logs</h3>
                                                </div>
                                            </div>
                                        </div>
                                        <form id="call-log-form" method="post" action="{{ route('projects.call.logs') }}">
                                            ...
                                            <div class="row g-3 mb-3">
                                                <div class="col-md-12">
                                                    <div class="col-sm-12 mb-3">
                                                        <label for="call_no" class="form-label">Select Call</label><br />
                                                        <select class=" form-control select2" aria-label="Default Select call" id="call_no" name="call_no">
                                                            <option value="">Select Call</option>
                    ...
                    <div class="card card-info mt-2">
                        <div class="card-body">
                            <div class="row clearfix">
                                <div class="col-md-12">
                                    <div class="card border-0 mb-4 no-bg">
                                        <div class="card-header py-3 px-0 d-sm-flex align-items-center  justify-content-between text-center border">
                                ...
                                @foreach ($logs as $key => $log)
                                <div class="col-sm-4 mb-3">
                                    <label for="formFileMultipleoneone" class="form-label fw-bold flex-fill mb-2 mt-sm-0"> {{$log->call->name }} :</label>
                                    <textarea class="form-control" disabled rows="3">{{ $log->notes }}</textarea>
                                </div>
                                @endforeach
                                    ...
                                    <div class="chat">
                                        ...
                                        <div class="chat-message clearfix">
                                            <div class="input-group mb-0">
                                                ...
                                                <div class="input-group-prepend"><span class="input-group-text" onclick="openEmailModal()"><i class="fa fa-send"></i></span></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="deadline-form" id="empform">
                        <div class="row g-3 mb-3">
                            ...
                            <div class="mb-1">
                                ...
                                <textarea type="text" class="form-control" id="content" name="content" placeholder="Enter Subject" value=""></textarea>
                                <div id="name_message" class="text-danger message mt-2"></div>
                            </div>
                            <div class="mb-1">
