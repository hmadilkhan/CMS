                ...
                <div class="tab-pane fade" id="emails" role="tabpanel">
                    <div class="container">
                        ...
                        <form id="emailform" method="post" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="department_id" value="{{ $project->department_id }}" />
                            <input type="hidden" name="customer_email" value="{{ $project->customer->email }}" />
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="card card-info mt-2">
                                        <div class="card-body">
                                            <div class="row clearfix">
                                                <div class="col-md-12">
                                                    <div class="card border-0 mb-4 no-bg">
                                                        <div class="card-header py-3 px-0 d-sm-flex align-items-center  justify-content-between border-bottom">
                                                            <h3 class=" fw-bold flex-fill mb-0 mt-sm-0 m-4">Emails
                                                            </h3>
                                                        </div>
                                                    </div>
                                                </div>
                ...
                <div class="modal-body">
                    <div class="deadline-form" id="empform">
                        <div class="row g-3 mb-3">
                            <div class="mb-1">
                                <label for="exampleFormControlInput877" class="form-label">Subject</label>
                                <input type="text" class="form-control" id="subject1" name="subject" placeholder="Enter Subject" value="">
                                <div id="name_message" class="text-danger message mt-2"></div>
                            </div>
                            <div class="mb-1">
                                <label for="exampleFormControlInput877" class="form-label">Content</label>
                                <textarea type="text" class="form-control" id="content1" name="content" placeholder="Enter Subject" value=""></textarea>
                                <div id="name_message" class="text-danger message mt-2"></div>
                            </div>
                            <div class="mb-1">
                                <label for="exampleFormControlInput877" class="form-label">Attachments</label>
