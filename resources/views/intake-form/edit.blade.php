...
<div class="premium-card">
    <div class="premium-header">
        <div class="d-sm-flex align-items-center justify-content-between">
            <h3 class="fw-bold mb-0">
                <i class="icofont-ui-note me-2"></i>Edit Intake Form
            </h3>
    ...
    <div class="card-body p-4">
        <form id="form" method="post" action="{{ route('intake-form.update', $customer->id) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="premium-section">
                ...
                <div class="row g-3">
                    <div class="col-sm-6">
                        ...
                        <input type="text" class="form-control premium-input" id="first_name" name="first_name" placeholder="Enter first name" value="{{ $customer->first_name }}">
                        @error('first_name')
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="text" class="form-control premium-input" id="last_name" name="last_name" placeholder="Enter last name" value="{{ $customer->last_name }}">
                        @error('last_name')
                            <div class="text-danger mt-2">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-sm-4">
                        ...
                        <input type="text" class="form-control premium-input" id="street" name="street" placeholder="Enter street" value="{{ $customer->street }}">
                        @error('street')
                            <div class="text-danger mt-2">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-sm-4">
                        ...
                        <input type="text" class="form-control premium-input" id="city" name="city" placeholder="Enter city" value="{{ $customer->city }}">
                        @error('city')
                            <div class="text-danger mt-2">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-sm-4">
                        ...
                        <input type="text" class="form-control premium-input" id="state" name="state" placeholder="Enter state" value="{{ $customer->state }}">
                        @error('state')
                            <div class="text-danger mt-2">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-sm-4">
                        ...
                        <input type="text" class="form-control premium-input" id="zipcode" name="zipcode" placeholder="Enter zip code" value="{{ $customer->zipcode }}">
                        @error('zipcode')
                            <div class="text-danger mt-2">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-sm-4">
                        ...
                        <input type="text" class="form-control premium-input" id="phone" name="phone" placeholder="Enter phone" value="{{ $customer->phone }}">
                        @error('phone')
                            <div class="text-danger mt-2">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-sm-4">
                        ...
                        <input type="text" class="form-control premium-input" id="email" name="email" placeholder="Enter email" value="{{ $customer->email }}">
                        @error('email')
                            <div class="text-danger mt-2">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="premium-section">
                ...
                <div class="row g-3">
                    <div class="col-sm-4">
                        ...
                        <input type="date" class="form-control premium-input" id="sold_date" name="sold_date" value="{{ $customer->sold_date }}">
                        @error('sold_date')
                            <div class="text-danger mt-2">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-sm-4">
                        ...
                        <select class="form-select select2 premium-input" id="sales_partner_id" name="sales_partner_id">
                            ...
                            @foreach ($partners as $partner)
                                <option {{ $customer->sales_partner_id == $partner->id ? 'selected' : '' }} value="{{ $partner->id }}">{{ $partner->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-sm-4">
                        ...
                        <select class="form-select select2 premium-input" id="sales_partner_user_id" name="sales_partner_user_id">
                            ...
                            @foreach ($users as $user)
                                <option {{ $customer->project->sales_partner_user_id == $user->id ? 'selected' : '' }} value="{{ $user->id }}">{{ $user->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-sm-6">
                        ...
                        <select class="form-select select2 premium-input" id="sub_contractor_id" name="sub_contractor_id">
                            ...
                            @foreach ($contractors as $contractor)
                                <option @selected($customer->sub_contractor_id == $contractor->id) value="{{ $contractor->id }}">{{ $contractor->name }}</option>
                            @endforeach
                        </select>
            ...
            <div class="premium-section">
                ...
                <div class="row g-3">
                    <div class="col-sm-4">
                        ...
                        <select class="form-select select2 premium-input" id="inverter_type_id" name="inverter_type_id" onchange="getRedlineCost()">
                            ...
                            @foreach ($inverter_types as $inverter)
                                <option {{ $customer->inverter_type_id == $inverter->id ? 'selected' : '' }} value="{{ $inverter->id }}">{{ $inverter->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-sm-4">
                        ...
                        <select class="form-select select2 premium-input" id="module_type_id" name="module_type_id" onchange="calculateSystemSize()">
                            ...
                            @foreach ($modules as $module)
                                <option {{ $customer->module_type_id == $module->id ? 'selected' : '' }} value="{{ $module->id }}">{{ $module->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="text" class="form-control premium-input" id="panel_qty" name="panel_qty" placeholder="Enter panel quantity" onblur="calculateSystemSizeAmount()" value="{{ $customer->panel_qty }}">
                        @error('panel_qty')
                            <div class="text-danger mt-2">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-sm-4">
                        ...
                        <input type="text" class="form-control premium-input" id="module_qty" name="module_qty" placeholder="System size" value="{{ $customer->module_value }}">
                        @error('module_qty')
                            <div class="text-danger mt-2">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-sm-4">
                        ...
                        <input type="text" class="form-control premium-input" id="inverter_qty" name="inverter_qty" placeholder="Inverter quantity" value="{{ $customer->inverter_qty }}">
                        @error('inverter_qty')
                            <div class="text-danger mt-2">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div id="loadIdDiv" class="col-sm-6">
                        ...
                        <input type="text" class="form-control premium-input" id="loanId" name="loanId" placeholder="Enter loan ID" value="{{$customer->loan_id}}">
                        @error('loanId')
                            <div class="text-danger mt-2">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="premium-section">
                ...
                <div class="row g-3">
                    <div class="col-sm-3">
                        ...
                        <select class="form-select select2 premium-input" id="finance_option_id" name="finance_option_id">
                            ...
                            @foreach ($financeoptions as $financeOption)
                                <option {{ $customer->finances->finance_option_id == $financeOption->id ? 'selected' : '' }} value="{{ $financeOption->id }}">{{ $financeOption->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-sm-3">
                        ...
                        <input type="text" class="form-control premium-input" id="contract_amount" name="contract_amount" placeholder="0" onblur="dealerFee()" value="{{ $customer->finances->contract_amount }}">
                    ...
                    <div class="col-sm-3">
                        ...
                        <input type="text" class="form-control premium-input" id="redline_costs" name="redline_costs" placeholder="0" value="{{ $customer->finances->redline_costs }}">
                        @error('redline_costs')
                            <div class="text-danger mt-2">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-sm-3">
                        <label class="form-label premium-label">Adders</label>
                        <input type="text" class="form-control premium-input" id="adders_amount" name="adders_amount" placeholder="0" value="{{ $customer->finances->adders }}">
                        @error('adders')
                            <div class="text-danger mt-2">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-sm-3">
                        ...
                        <input type="text" class="form-control premium-input" id="commission" name="commission" placeholder="0" value="{{ $customer->finances->commission }}">
                        @error('commission')
                            <div class="text-danger mt-2">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-sm-3">
                        ...
                        <input readonly type="text" class="form-control premium-input" id="dealer_fee" name="dealer_fee" placeholder="0" value="{{ $customer->finances->dealer_fee }}">
                        @error('dealer_fee')
                            <div class="text-danger mt-2">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-sm-3">
                        ...
                        <input type="text" class="form-control premium-input" id="dealer_fee_amount" name="dealer_fee_amount" placeholder="0" value="{{ $customer->finances->dealer_fee_amount }}">
            ...
            <div class="text-center mt-4">
                <button type="submit" class="btn premium-btn btn-lg px-5">
                    <i class="icofont-save me-2"></i>Update Intake Form
                </button>
            </div>
        </form>
    </div>
