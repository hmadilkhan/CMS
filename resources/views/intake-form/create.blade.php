        ...
        <div class="card-body p-4">
            <form id="form" method="post" action="{{ route('intake-form.store') }}" enctype="multipart/form-data">
                            ...
                            <select class="form-select select2 premium-input" id="module_type_id" name="module_type_id"
                                ...
                                @foreach ($modules as $module)
                                    <option value="{{ $module->id }}">
                                        {{ $module->inverter->name . ' ' . $module->name }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-sm-3">
                            ...
                            <input type="text" class="form-control premium-input" id="contract_amount"
                                name="contract_amount" placeholder="0" onblur="dealerFee()" value="0">
                        ...
                        <div class="col-sm-3">
                            ...
                            <input readonly type="text" class="form-control premium-input" id="redline_costs"
                                name="redline_costs" placeholder="0" value="0">
                            @error('redline_costs')
                                <div class="text-danger mt-2">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-sm-3">
                            <label class="form-label premium-label">Adders</label>
                            <input readonly type="text" class="form-control premium-input" id="adders_amount"
                                name="adders_amount" placeholder="0" value="0">
                            @error('adders')
                                <div class="text-danger mt-2">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-sm-3">
                            ...
                            <input readonly type="text" class="form-control premium-input" id="dealer_fee"
                                name="dealer_fee" placeholder="0" value="0">
                            @error('dealer_fee')
                                <div class="text-danger mt-2">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-sm-3">
                            ...
                            <input readonly type="text" class="form-control premium-input" id="dealer_fee_amount"
                                name="dealer_fee_amount" placeholder="0" value="0">
                ...
                <div class="premium-section">
                    ...
                    <p class="text-muted">After creating the intake form, you can schedule a site survey for this project.
                    </p>
