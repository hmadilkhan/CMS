        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ !empty($user) ? route('update.user') : route('store.register') }}"
                ...
                <div class="row g-3  mb-3 align-items-center">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <select id="user_type_id" name="user_type_id"
                                class="form-control select2 @error('type') is-invalid @enderror" style="width: 100%;">
                                ...
                                @foreach ($types as $typeValue)
                                    ...
                                    @else
                                        <option value="{{ $typeValue->id }}"
                                            {{ old('type') == $typeValue->id ? 'selected' : '' }}>
                                            {{ $typeValue->name }}
                                        </option>
                                    @endif
                                @endforeach
                    ...
                    <div class="col-sm-3" id="salesPartnerDiv"
                    ...
                    <div class="col-sm-3" id="addressDiv"
                        style="{{ !empty($user) && $user->user_type_id == 5 ? 'display:block' : 'display:none' }}">
                        <div class="form-group">
                            <label>Address</label>
                            <input {{ !empty($user) ? 'disabled' : '' }} type="text" class="form-control"
